...
#define	MAX_EDITROW		1500	/* 程絪胯︽计 */
...
/* chinsan.20010103: 暗虏虫いゅ秆睦...
 * MAXMOVIE -------------> –絞笆篈狾程碭︽
 * ACBOARD_BUFSIZE ------> –絞笆篈狾い–︽程碭じ 
 * ACBOARD_MAXLINE ------> 笆篈狾场甧程ぶ︽
 * 碞琌弧ACBOARD(笆篈狾) 场甧秖 80 ︽–絞程 8 ︽
 *  80/8 = 10 絞–絞い–︽程 150 じ
 */
