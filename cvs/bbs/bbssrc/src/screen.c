...
int     line, mode;
{
/* Sonny.990608 ­×´_­«´_¨Ï¥Î saveline ®É·|§â¿Ã¹õ§Ë¶Ãªº°ÝÃD */
/* 		¥Ø«e¬O¥Î¤gªk·Ò¿ûªº¤è¦¡­×ªº, ¤ñ¸ûªá CPU ¤]¤ñ¸û¥e memory */

	register struct screenline *bp = big_picture;
	static char linetmp[2][256];	/* ¥Î¨Ó¦s¨ú³QÂÐ»\ªº¨º¦æ */
	static char linetmptmp[2][256];	/* ¥Î¨Ó¦s¨ú­«½Æ³QÂÐ»\ªº¨º¦æ */
	static int savelinerecorder[2] = {0, 0};	/* °O¾Ð¬O§_³Q­«½ÆÂÐ»\ */
	int     x, y;
	switch (mode) {
	case 0:
	case 2:
